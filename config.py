...
API_ID = 28834400
API_HASH = "86f2be3e75912c0e262b3dc17d4b6553"
...
SUDO_USERS = list(map(lambda x: int(x), getenv("SUDO_USERS", default="5901389360").split()))
for x in ALTRON:
    SUDO_USERS.append(x)
OWNER_ID = int(getenv("OWNER_ID", default="5901389360"))
